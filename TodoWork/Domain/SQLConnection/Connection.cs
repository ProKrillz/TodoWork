...
public class Connection : IConnection
{
    ...
    public async Task UpdateUser(DTOUser dtoUser)
    {
        User user = DTOUserMappingUser(dtoUser);
    ...
    public async Task<DTOUser> UserLogin(string email, string password)
    {
    ...
    public async Task<DTOUser> GetUserById(Guid id)
    {
